...
from .stdmae_arch import STD_ITR15
...
CFG.DATASET_INPUT_LEN = 3
CFG.DATASET_OUTPUT_LEN = 3
CFG.DATASET_ARGS = {
    "seq_len": 288*3
    }
CFG.GPU_NUM = 1
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STD_ITR15"
CFG.MODEL.ARCH = STD_ITR15
adj_mx, _ = load_adj("datasets/" + CFG.DATASET_NAME + "/adj_mx.pkl", "doubletransition")
CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "pre_trained_tmae_path": "mask_save/TMAE_PEMS_864.pt",
    "pre_trained_smae_path": "mask_save/SMAE_PEMS_864.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
